          ...
          <div className="max-container grid md:grid-cols-4 mb-8 text-white gap-3 md:gap-12">
            <div>
              ...
              <div className="w-full bg-white mt-2">
                <div className="border border-[#E25111] w-[40%] h-0"></div>
              </div>
              <div className="mt-4 md:mt-8">
                <p>
                  At Cooking Classy, chefs are family. That's why, for over
                  three decades, our editors have devoted countless hours and
                  thousands of meals to scouting.
                </p>
                <p className="mt-3">
                  Discovering the most talented up-and-comers in America.
                </p>
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-4 md:mt-8">
                ...
                <input
                  type="email"
                  className="w-[80%] text-black h-7 mt-4 bg-white rounded-full outline-none px-4 text-sm"
                  placeholder="Email address"
                />
                <button className="px-3 py-1 bg-[#E25111] rounded-full outline-none text-white font-medium text-sm mt-3">
                  Subscribe
                </button>
              </div>
            </div>
