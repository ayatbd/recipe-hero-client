        ...
        <div className="flex flex-col gap-5">
          <div className="bg-slate-200 p-5 rounded-md shadow hover:shadow-lg">
            ...
            <p className="text-gray-600">
              Ans: The difference between uncontrolled and controlled components
              is that they are controlled by the parent component. The parent
              component is the component that is controlled by the child
              component. The child component is the component that is controlled
          ...
          <div className="bg-slate-200 p-5 rounded-md shadow hover:shadow-lg">
            ...
            <p className="text-gray-600">
              ...
              the expected types of props that a component should receive. This
              helps to catch errors early on and make your code more robust.
            </p>
          </div>
          <div className="bg-slate-200 p-5 rounded-md shadow hover:shadow-lg">
            <h1 className="text-xl font-semibold mb-3">
              Question-03: Tell us the difference between nodejs and express js?
            </h1>
            <p className="text-gray-600">
